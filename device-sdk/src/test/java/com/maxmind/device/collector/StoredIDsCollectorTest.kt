...
internal class StoredIDsCollectorTest {
    private lateinit var mockContext: Context
    private lateinit var mockContentResolver: ContentResolver
    private lateinit var collector: StoredIDsCollector
    ...
    internal fun setUp() {
        ...
        collector = StoredIDsCollector(mockContext)
    }
    ...
    @Test
    internal fun `collect returns StoredIDs with androidID when available`() {
    ...
    internal fun `WIDEVINE_UUID has correct value`() {
        ...
        assertEquals(expectedUuid, StoredIDsCollector.WIDEVINE_UUID)
    }

    @Test
    internal fun `collect returns StoredIDs object even when all values null`() {
        mockkStatic(Settings.Secure::class)
        every {
            Settings.Secure.getString(mockContentResolver, Settings.Secure.ANDROID_ID)
        } returns null
